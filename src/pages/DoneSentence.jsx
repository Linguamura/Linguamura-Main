      ...
      <div className="bg-white rounded-lg shadow-md w-full max-w-md p-6">
        <div className="flex flex-col items-center">
          ...
          <div className="w-24 h-24 rounded-full bg-gray-200 overflow-hidden mb-4">
            <img
              src="/images/homepage/Music.png" // Replace with actual image source
              alt="Person"
          ...
          <button className="mt-4 py-2 px-4 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300">
            Continue
          </button>
        </div>
      </div>
